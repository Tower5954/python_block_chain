...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "pip._internal.util.logging.ColorizedStreamHandler",
        "file": "pip._internal.util.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "pip._internal.util.logging.MaxLevelFilter",
            ...
            "exclude_subprocess": {
                "()": "pip._internal.util.logging.ExcludeLoggerFilter",
                "name": subprocess_logger.name,
            },
        },
        "formatters": {
